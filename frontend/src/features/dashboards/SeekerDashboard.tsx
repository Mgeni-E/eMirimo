    ...
    <DashboardLayout>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 bg-accent-50 dark:bg-accent-900/20 rounded-lg flex items-center justify-center">
              <ApplicationsIcon className="w-6 h-6 text-accent-600 dark:text-accent-400" />
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Recommended Jobs</h3>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="text-center py-8">
          ...
          <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Boost Your Skills</h4>
          <p className="text-gray-600 dark:text-gray-400 mb-4">Access personalized learning resources to improve your job prospects</p>
          <Link 
            to="/learning" 
